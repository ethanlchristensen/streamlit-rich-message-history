...
class TestCustomComponents:
    def setup_method(self):
        ...
        self._original_custom_types = (
            ComponentRegistry._custom_types.copy()
            if hasattr(ComponentRegistry, "_custom_types")
            else {}
        )
        self._original_type_detectors = (
            ComponentRegistry._type_detectors.copy()
            if hasattr(ComponentRegistry, "_type_detectors")
            else {}
        )
        self._original_type_renderers = (
            ComponentRegistry._type_renderers.copy()
            if hasattr(ComponentRegistry, "_type_renderers")
            else {}
        )
        self._original_methods = (
            Message._custom_component_methods.copy()
